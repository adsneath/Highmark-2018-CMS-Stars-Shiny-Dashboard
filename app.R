...
DMD15 <- read.csv("data/DMD15.csv")
C12 <- read.csv("data/C12.csv")
C14 <- read.csv("data/C14.csv")
C15 <- read.csv("data/C15.csv")
C17 <- read.csv("data/C17.csv")
C20 <- read.csv("data/C20.csv")
C01 <- read.csv("data/C01.csv")
C02 <- read.csv("data/C02.csv")
C07 <- read.csv("data/C07.csv")
C13 <- read.csv("data/C13.csv")
C21 <- read.csv("data/C21.csv")
D11 <- read.csv("data/D11.csv")
D12 <- read.csv("data/D12.csv")
D13 <- read.csv("data/D13.csv")
D14 <- read.csv("data/D14.csv")
DMC17 <- read.csv("data/DMC17.csv")

DMD15Ranked <- read.csv("data/DMD15Ranked.csv")
C12Ranked <- read.csv("data/C12Ranked.csv")
C14Ranked <- read.csv("data/C14Ranked.csv")
C15Ranked <- read.csv("data/C15Ranked.csv")
C17Ranked <- read.csv("data/C17Ranked.csv")
C20Ranked <- read.csv("data/C20Ranked.csv")
C01Ranked <- read.csv("data/C01Ranked.csv")
C02Ranked <- read.csv("data/C02Ranked.csv")
C07Ranked <- read.csv("data/C07Ranked.csv")
C13Ranked <- read.csv("data/C13Ranked.csv")
C21Ranked <- read.csv("data/C21Ranked.csv")
D11Ranked <- read.csv("data/D11Ranked.csv")
D12Ranked <- read.csv("data/D12Ranked.csv")
D13Ranked <- read.csv("data/D13Ranked.csv")
D14Ranked <- read.csv("data/D14Ranked.csv")
DMC17Ranked <- read.csv("data/DMC17Ranked.csv")
